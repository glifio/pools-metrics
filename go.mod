module github.com/glifio/pools-metrics

go 1.20

replace github.com/glifio/go-pools v0.0.0-20230904034119-e659a0542cc1 => ../go-pools
...
require (
	...
	github.com/glifio/go-pools v0.0.0-20231212170011-d09d785ae45a
)
